...
#### 3) Install CHELSA_Download v0.3.2 from the GitHub tag tarball
```bash
python -m pip install "https://github.com/miguelaristizabal/CHELSA_Download/archive/refs/tags/v0.3.2.tar.gz"
```
...
To install a different version, replace `v0.3.2` in the URL with the tag you want.
